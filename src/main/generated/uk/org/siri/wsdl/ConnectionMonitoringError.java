...
public class ConnectionMonitoringError
    extends Exception
{
     ...
     * @param message
     */
    public ConnectionMonitoringError(String message, ServiceDeliveryErrorConditionStructure faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ConnectionMonitoringError(String message, ServiceDeliveryErrorConditionStructure faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
