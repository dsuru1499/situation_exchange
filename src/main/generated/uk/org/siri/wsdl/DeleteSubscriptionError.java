...
public class DeleteSubscriptionError
    extends Exception
{
     ...
     * @param message
     */
    public DeleteSubscriptionError(String message, ErrorConditionStructure faultInfo) {
        super(message);
     ...
     * @param message
     */
    public DeleteSubscriptionError(String message, ErrorConditionStructure faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
