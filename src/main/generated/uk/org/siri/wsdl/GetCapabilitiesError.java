...
public class GetCapabilitiesError
    extends Exception
{
     ...
     * @param message
     */
    public GetCapabilitiesError(String message, ErrorConditionStructure faultInfo) {
        super(message);
     ...
     * @param message
     */
    public GetCapabilitiesError(String message, ErrorConditionStructure faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
