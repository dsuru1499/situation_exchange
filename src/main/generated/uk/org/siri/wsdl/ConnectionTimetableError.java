...
public class ConnectionTimetableError
    extends Exception
{
     ...
     * @param message
     */
    public ConnectionTimetableError(String message, ServiceDeliveryErrorConditionStructure faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ConnectionTimetableError(String message, ServiceDeliveryErrorConditionStructure faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
