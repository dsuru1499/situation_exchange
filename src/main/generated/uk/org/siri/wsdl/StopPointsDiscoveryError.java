...
public class StopPointsDiscoveryError
    extends Exception
{
     ...
     * @param message
     */
    public StopPointsDiscoveryError(String message, ErrorConditionStructure faultInfo) {
        super(message);
     ...
     * @param message
     */
    public StopPointsDiscoveryError(String message, ErrorConditionStructure faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
