...
public class ConnectionLinksDiscoveryError
    extends Exception
{
     ...
     * @param message
     */
    public ConnectionLinksDiscoveryError(String message, ErrorConditionStructure faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ConnectionLinksDiscoveryError(String message, ErrorConditionStructure faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
