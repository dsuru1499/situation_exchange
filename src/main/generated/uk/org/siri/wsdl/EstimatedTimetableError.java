...
public class EstimatedTimetableError
    extends Exception
{
     ...
     * @param message
     */
    public EstimatedTimetableError(String message, ServiceDeliveryErrorConditionStructure faultInfo) {
        super(message);
     ...
     * @param message
     */
    public EstimatedTimetableError(String message, ServiceDeliveryErrorConditionStructure faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
