...
public class ProductionTimetableError
    extends Exception
{
     ...
     * @param message
     */
    public ProductionTimetableError(String message, ServiceDeliveryErrorConditionStructure faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ProductionTimetableError(String message, ServiceDeliveryErrorConditionStructure faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
