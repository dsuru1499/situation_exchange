...
public class SituationExchangeError
    extends Exception
{
     ...
     * @param message
     */
    public SituationExchangeError(String message, ServiceDeliveryErrorConditionStructure faultInfo) {
        super(message);
     ...
     * @param message
     */
    public SituationExchangeError(String message, ServiceDeliveryErrorConditionStructure faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
