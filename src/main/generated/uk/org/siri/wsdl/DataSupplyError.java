    ...
    extends Exception
{
     ...
     * @param message
     */
    public DataSupplyError(String message, ErrorConditionStructure faultInfo) {
        super(message);
     ...
     * @param message
     */
    public DataSupplyError(String message, ErrorConditionStructure faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
