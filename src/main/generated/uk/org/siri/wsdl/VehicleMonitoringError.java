...
public class VehicleMonitoringError
    extends Exception
{
     ...
     * @param message
     */
    public VehicleMonitoringError(String message, ServiceDeliveryErrorConditionStructure faultInfo) {
        super(message);
     ...
     * @param message
     */
    public VehicleMonitoringError(String message, ServiceDeliveryErrorConditionStructure faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
