    ...
    extends Exception
{
     ...
     * @param message
     */
    public CheckStatusError(String message, ErrorConditionStructure faultInfo) {
        super(message);
     ...
     * @param message
     */
    public CheckStatusError(String message, ErrorConditionStructure faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
