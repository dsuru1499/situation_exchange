...
public class SituationExchangeRestService extends SituationExchange {
	...
	String[] x = {
			...
			// SituationBaseIdentityGroup
			// "countryRef",
			"participantRef", "situationNumber",
			...
			// PtSituationBodyGroup

			// StatusGroup
			// "verification",
			"progress", "qualityIndex", "reality",
			// "likelihood",
			// "publication",
			...
			// TemporalGroup
			"validityPeriod", "repetitions", "publicationWindow",

			// --> ClassifierGroup

			// TpegReasonGroup
			"unknownReason", "miscellaneousReason", "personnelReason", "equipmentReason", "environmentReason", "undefinedReason",

			"miscellaneousSubReason", "personnelSubReason", "equipmentSubReason", "environmentSubReason",
			...
			"severity",
			// "priority",
			"sensitivity", "audience", "scopeType",
			// "reportType",
			// "planned",
			"keywords",
			// "secondaryReasons",
			...
			"consequences", "publishingActions", };
}
